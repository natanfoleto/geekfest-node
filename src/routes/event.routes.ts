...
import { FindUsersTeamsController } from '@modules/event/useCases/findUserEvent/findUserEventController';
...
eventRoutes.get('/usersteams', new FindUsersTeamsController().handle);
